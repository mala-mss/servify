                  ...
                  <div style={styles.notifDropList}>
                    ...
                    {notifications.map(n => (
                      <div 
                        key={n.id} 
                        style={{ 
                          ...styles.notifDropItem, 
                          borderBottomColor: p.border,
                          background: n.type === 'payment' ? (theme === 'dark' ? 'rgba(245,158,11,0.03)' : 'rgba(245,158,11,0.05)') : 'transparent'
                        }}
                      >
                        ...
                        {n.type === 'payment' && (
                          <button 
                            onClick={() => {
                              // Instead of internal payment modal, we could redirect or handle it here
                              alert(`Payment for ${n.bookingId} will be processed here.`);
                              setShowNotif(false);
                            }}
                            style={{ 
                              marginTop: 8, 
