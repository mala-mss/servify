  ...
  return (
    <div style={{ animation: "fadeUp .4s ease both" }}>
      <div style={{ marginBottom: 32 }}>
        ...
        <h1 style={{ fontFamily: "'Instrument Serif', serif", fontSize: 32, color: p.text, fontWeight: 400, marginBottom: 8 }}>Add New Service</h1>
        <p style={{ color: p.textMuted, fontSize: 14 }}>Create a new service offering for your clients.</p>
      </div>
      ...
      <div style={cardStyle}>
        <form onSubmit={(e) => { e.preventDefault(); navigate("/provider/my-services"); }}>
          ...
          <input 
            type="text" 
            placeholder="e.g. Weekend Babysitting"
